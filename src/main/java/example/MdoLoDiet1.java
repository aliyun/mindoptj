    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            for (int i = 0; i < food.size(); i++) {
                String name = food.getString(i, 0);
                double lb = food.getDouble(i, 1);
                double ub = food.getDouble(i, 2);
                double obj = food.getDouble(i, 3);
                MdoVar var = model.addVar(lb, ub, obj, false, name);
                namedVars.put(name, var);
            }
            ...
            for (int i = 0; i < req.size(); i++) {
                ...
                model.addRange(expr, lhs, rhs, req.getString(i, 0));
            }
